...
post{
   success {
          script{
              d='{"teamName":"MYLTA","jobtitle":"'+JOB_NAME+'","bNumber":"'+BUILD_NUMBER+'","bUrl":"'+BUILD_URL+'","buildStatus":"SUCCESS"}'
         ...
         failure {
            script{
              d='{"teamName":"MYLTA","jobtitle":"'+JOB_NAME+'","bNumber":"'+BUILD_NUMBER+'","bUrl":"'+BUILD_URL+'","buildStatus":"FAILURE"}'
