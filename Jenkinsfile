...
post{
   success {
          script{
              d='{"teamName":"GATKA","jobtitle":"'+JOB_NAME+'","bNumber":"'+BUILD_NUMBER+'","bUrl":"'+BUILD_URL+'","buildStatus":"SUCCESS"}'
         ...
         failure {
            script{
              d='{"teamName":"GATKA","jobtitle":"'+JOB_NAME+'","bNumber":"'+BUILD_NUMBER+'","bUrl":"'+BUILD_URL+'","buildStatus":"FAILURE"}'
